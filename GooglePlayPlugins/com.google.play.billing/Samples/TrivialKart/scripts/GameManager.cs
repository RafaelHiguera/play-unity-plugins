...
public class GameManager : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        Debug.Log(SecurityController.verifyAndSaveUserPurchase("tokenId"));
        // Debug.Log(SecurityController.verifyPurchase("com.package.test", "com.package.test.item", "tokenId"));
